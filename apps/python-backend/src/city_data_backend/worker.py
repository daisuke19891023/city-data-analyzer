...
from city_data_backend.database import get_engine, session_scope
...
from city_data_backend.services.optimization import (
...
if TYPE_CHECKING:
    ...
    from city_data_backend.models.dspy import QuerySpecDict
