...
from city_data_backend.constants import PROJECT_NAME
from city_data_backend.database import get_session
from city_data_backend.db_models import (
...
from city_data_backend.models.experiments import (
...
from city_data_backend.models.feedback import FeedbackRequest, FeedbackResponse
from city_data_backend.services.datasets import (
    DatasetMetadata,
    DatasetRepository,
    init_database,
)
...
class RestAPIInterface(BaseInterface):
    ...
    def _setup_swagger_routes(self) -> None:
        ...
        async def enhanced_swagger_ui() -> str:  # type: ignore[misc]
            ...
            interfaces_summary = ", ".join(
                sorted(interface.value for interface in InterfaceType),
            )
...
<head>
    ...
    <title>{PROJECT_NAME.title()} API - Enhanced Documentation</title>
...
<body>
    ...
    <div style=\"margin: 20px; padding: 15px; background-color: #f8fafc;
        ...
        <p>Available interfaces: {interfaces_summary}</p>
    </div>
</body>
</html>"""
