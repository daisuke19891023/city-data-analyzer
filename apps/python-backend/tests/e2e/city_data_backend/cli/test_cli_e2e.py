...
class TestCLIE2E:
    ...
    def test_cli_shows_welcome_without_args(
        ...
        try:
            output, exitstatus = run_cli_with_debug(
                f"{sys.executable} -u -m city_data_backend.main",
                env=clean_env,
                timeout=10,
    ...
    def test_cli_help_command(
        ...
        try:
            output, exitstatus = run_cli_with_debug(
                f"{sys.executable} -u -m city_data_backend.main --help",
                env=clean_env,
                timeout=10,
    ...
    def test_cli_version_command(
        ...
        try:
            _, exitstatus = run_cli_with_debug(
                f"{sys.executable} -u -m city_data_backend.main --version",
                env=clean_env,
                timeout=10,
    ...
    def test_cli_invalid_command(
        ...
        try:
            output, exitstatus = run_cli_with_debug(
                f"{sys.executable} -u -m city_data_backend.main invalid-command",
                env=clean_env,
                timeout=10,
                debug=False,  # Disable debug for this test
            )
    ...
    def test_cli_explicit_welcome_command(
        ...
        try:
            output, exitstatus = run_cli_with_debug(
                f"{sys.executable} -u -m city_data_backend.main welcome",
                env=clean_env,
                timeout=10,
