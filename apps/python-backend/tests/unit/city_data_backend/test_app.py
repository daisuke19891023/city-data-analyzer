...
class TestApplication:
    ...
    @patch("city_data_backend.app.load_dotenv")
    @patch("city_data_backend.app.configure_logging")
    @patch("city_data_backend.app.get_logger")
    @patch("city_data_backend.app.get_settings")
    @patch("city_data_backend.app.get_interface_settings")
    @patch("city_data_backend.app.InterfaceFactory")
...
def test_create_app() -> None:
    ...
    with patch("city_data_backend.app.Application") as mock_app_class:
        mock_app = MagicMock()
...
def test_run_app() -> None:
    ...
    with patch("city_data_backend.app.create_app") as mock_create_app:
        mock_app = MagicMock()
