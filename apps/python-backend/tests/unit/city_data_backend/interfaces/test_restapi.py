...
class TestRestAPIInterface:
    ...
    def test_restapi_interface_app_title(self) -> None:
        ...
        api = RestAPIInterface()
        assert api.app.title == "City Data Backend API"
    ...
    @patch("city_data_backend.interfaces.restapi.uvicorn")
    ...
    def test_restapi_interface_initialization_logs(self) -> None:
        ...
        with patch("city_data_backend.base.get_logger") as mock_get_logger:
            # Setup mock logger
