...
from city_data_backend.utils.logger import LoggerProtocol


class TestBaseComponent:
    """Test cases for BaseComponent class."""

    @patch("city_data_backend.base.get_logger")
    def test_logger_initialization(self, mock_get_logger: Mock) -> None:
        ...
        mock_get_logger.assert_called_once_with(
            "city_data_backend.base.BaseComponent",
        )
    ...
    def test_inheritance(self, mock_get_logger: Mock) -> None:
        ...
        # Assert
        mock_get_logger.assert_called_once_with(
            "tests.unit.city_data_backend.test_base.CustomService",
        )
        assert instance.logger is mock_logger
